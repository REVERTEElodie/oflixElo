...
class MySluggerTest extends TestCase
{
    ...
    public function testSlugify($title, $expected, $isLower): void
    {
            ...
            $this->assertEquals($expected,$slugger->slugify($title));
    }

    // REFER : https://docs.phpunit.de/en/9.6/writing-tests-for-phpunit.html#data-providers
    public static function slugProvider(): Array
    {
        // on retourne un tableau de tests avec l'élément envoyé et l'élément attendu et le isLower
        return [
            ...
            ['avéc nombre 42 ?', 'avec-nombre-42', true],
        ];
    }
}