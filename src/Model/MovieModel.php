<?php
// Fichier : MovieModel.php | Date: 2024-01-01 | Auteur: Patrick SUFFREN

namespace App\Model;

/**
 * Retourne les films sous forme de tableau
 * @package App\Model
 */
class MovieModel
{
     ...
     * Get one movie
     */
    static public function getMovieById(int $id) 
    {
        // utilisation du return early pattern
